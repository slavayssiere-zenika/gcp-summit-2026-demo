...
async def publish_data_quality_snapshot(
    ...
    payload = {
        ...
        "score": report["score"],
        "grade": report["grade"],
        "embedding_pct": report["metrics"]["embedding"]["pct"],
        "missions_pct": report["metrics"]["missions"]["pct"],
        "competencies_pct": report["metrics"]["competencies"]["pct"],
        "summary_pct": report["metrics"]["summary"]["pct"],
        "current_role_pct": report["metrics"]["current_role"]["pct"],
        "competency_assignment_pct": report["metrics"]["competency_assignment"]["pct"],
        "ai_scoring_pct": report["metrics"]["ai_scoring"]["pct"],
