"""
Tests de non-régression : propagation du JWT sub comme user_id dans agent_missions_api.
...
def test_query_different_users_different_user_ids(client):
    ...
    async def capture(query, session_id, user_id="user_1", **kwargs):
        ...
        return {"response": "OK", "steps": [], "thoughts": "", "usage": {}, "source": "missions_agent"}
