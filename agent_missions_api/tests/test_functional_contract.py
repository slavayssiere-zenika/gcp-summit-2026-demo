...
def _make_jwt(sub: str = "user-1", role: str = "admin") -> str:
    ...
    # Use the actual SECRET_KEY captured by the middleware (prevents KeyError and 401 mismatches)
    return jwt.encode(payload, shared.auth.jwt.SECRET_KEY, algorithm="HS256")
