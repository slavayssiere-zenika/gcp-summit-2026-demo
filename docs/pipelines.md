...
> ⚙️ Document auto-généré le **2026-05-15 13:48 UTC** par `scripts/generate_pipeline_docs.py`.
...
> Dernière modification : `2026-05-13` · Cible : `slavayssiere-sandbox-462015` / `europe-west1` · Registre : `z-gcp-summit-services`
