...
> ⚙️ Document auto-généré le **2026-06-08 11:58 UTC** par `scripts/generate_pipeline_docs.py`.
...
> Dernière modification : `2026-05-29` · Cible : `slavayssiere-sandbox-462015` / `europe-west1` · Registre : `z-gcp-summit-services-dev`
