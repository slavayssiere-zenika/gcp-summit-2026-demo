...
with open('cv_api/src/services/cv_import_service.py', 'r') as f:
    text = f.read()

# I will write `cv_extraction_service.py` directly instead of parsing to be safer.
cv_extraction_service_code = """import json
import logging
import os
import re
import time
...
with open('cv_api/src/services/cv_extraction_service.py', 'w') as f:
    f.write(cv_extraction_service_code)
