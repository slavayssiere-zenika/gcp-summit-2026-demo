...
| Microservice     | Stmts | Miss | Cover |
|------------------|-------|------|-------|
| agent_commons    | 2855  | 695  |  76% |
| agent_hr_api     | 1570  | 102  |  94% |
| agent_missions_api | 1927  | 90   |  95% |
| agent_ops_api    | 2275  | 236  |  90% |
| agent_router_api | 3691  | 552  |  85% |
| analytics_mcp    | 1111  | 206  |  81% |
| competencies_api | 5824  | 956  |  84% |
| cv_api           | 10529 | 1581 |  85% |
| drive_api        | 3531  | 435  |  88% |
| items_api        | 2186  | 128  |  94% |
| missions_api     | 2231  | 281  |  87% |
| monitoring_mcp   | 1366  | 187  |  86% |
| platform-engineering | 2310  | 1552 |  33% |
| prompts_api      | 1355  | 250  |  82% |
| scratch          | N/A   | N/A  | N/A  |
| scripts          | N/A   | N/A  | N/A  |
| shared           | 3020  | 277  |  91% |
...
#### Commits non pushés
- chore: repository cleanup - remove logs, temp scripts, and sandbox directories

#### Fichiers (non commités)
- `gent_commons/agent_commons.egg-info/PKG-INFO` (D)
- `agent_commons/agent_commons.egg-info/SOURCES.txt` (D)
- `agent_commons/agent_commons.egg-info/dependency_links.txt` (D)
- `agent_commons/agent_commons.egg-info/requires.txt` (D)
- `agent_commons/agent_commons.egg-info/top_level.txt` (D)
- `agent_commons/agent_commons/__init__.py` (M)
- `agent_commons/agent_commons/runner.py` (M)
- `agent_commons/agent_commons/session.py` (M)
- `agent_commons/build/lib/agent_commons/__init__.py` (D)
- `agent_commons/build/lib/agent_commons/a2a_utils.py` (D)
- `agent_commons/build/lib/agent_commons/circuit_breaker.py` (D)
- `agent_commons/build/lib/agent_commons/exception_handler.py` (D)
- `agent_commons/build/lib/agent_commons/finops.py` (D)
- `agent_commons/build/lib/agent_commons/guardrails.py` (D)
- `agent_commons/build/lib/agent_commons/guardrails_grounding.py` (D)
- `agent_commons/build/lib/agent_commons/http_resilience.py` (D)
- `agent_commons/build/lib/agent_commons/mcp_client.py` (D)
- `agent_commons/build/lib/agent_commons/mcp_proxy.py` (D)
- `agent_commons/build/lib/agent_commons/metadata.py` (D)
- `agent_commons/build/lib/agent_commons/prompt_loader.py` (D)
- `agent_commons/build/lib/agent_commons/runner.py` (D)
- `agent_commons/build/lib/agent_commons/schemas.py` (D)
- `agent_commons/build/lib/agent_commons/session.py` (D)
- `agent_commons/build/lib/agent_commons/taxonomy_utils.py` (D)
- `agent_commons/build/lib/agent_commons/ui_tools.py` (D)
...
- `agent_router_api/pyproject.toml` (M)
- `agent_router_api/requirements.txt` (M)
- `agent_router_api/spec.md` (M)
- `agent_router_api/tests/test_agent.py` (M)
- `agent_router_api/uv.lock` (M)
- `analytics_mcp/FILE_HASHES` (M)
- `analytics_mcp/HASH` (M)
- `analytics_mcp/VERSION` (M)
- `analytics_mcp/pyproject.toml` (M)
- `analytics_mcp/uv.lock` (M)
- `competencies_api/FILE_HASHES` (M)
- `competencies_api/HASH` (M)
- `competencies_api/VERSION` (M)
- `competencies_api/mcp_server.py` (M)
- `competencies_api/pyproject.toml` (M)
...
- `cv_api/uv.lock` (M)
- `data_ingestion/france_travail_ingestion.py` (D)
- `data_ingestion/pyproject.toml` (D)
- `data_ingestion/uv.lock` (D)
- `db_migrations/VERSION` (M)
- `drive_api/FILE_HASHES` (M)
- `drive_api/HASH` (M)
- `drive_api/VERSION` (M)
- `drive_api/pyproject.toml` (M)
- `drive_api/spec.md` (M)
- `drive_api/uv.lock` (M)
- `frontend/FILE_HASHES` (M)
- `frontend/HASH` (M)
...
- `missions_api/HASH` (M)
- `missions_api/VERSION` (M)
- `missions_api/pyproject.toml` (M)
- `missions_api/spec.md` (M)
- `missions_api/uv.lock` (M)
- `monitoring_mcp/FILE_HASHES` (M)
- `monitoring_mcp/HASH` (M)
- `monitoring_mcp/VERSION` (M)
...
- `platform-engineering/envs/prd.yaml` (M)
- `platform-engineering/manage_env.py` (M)
- `platform-engineering/pyproject.toml` (M)
- `platform-engineering/requirements.txt` (M)
...
- `prompts_api/HASH` (M)
- `prompts_api/VERSION` (M)
- `prompts_api/pyproject.toml` (M)
- `prompts_api/spec.md` (M)
- `prompts_api/uv.lock` (M)
- `run_git_push.sh` (M)
- `scripts/deploy.sh` (M)
- `scripts/local_up.py` (M)
- `scripts/mcp_cli.py` (M)
- `shared/FILE_HASHES` (M)
- `shared/HASH` (M)
- `shared/VERSION` (M)
- `shared/pyproject.toml` (M)
- `talk/biographie.md` (D)
- `talk/generate_slides.py` (D)
- `talk/presentation_plan.json` (D)
- `talk/prompt_generate_plan.md` (D)
- `talk/proposition_talk.md` (D)
- `talk/pyproject.toml` (D)
- `talk/template_notes.md` (D)
- `talk/uv.lock` (D)
- `todo.md` (M)
- `users_api/FILE_HASHES` (M)
- `users_api/HASH` (M)
- `users_api/VERSION` (M)
- `users_api/pyproject.toml` (M)
- `users_api/src/users/system_router.py` (M)
- `users_api/tests/integration/conftest.py` (M)
- `users_api/uv.lock` (M)
- `agent_commons/agent_commons/memory.py` (??)
- `frontend/src/components/ConsultantDashboard.vue` (??)
- `scripts/clear_semantic_cache.py` (??)
- `scripts/merge_rousseau.py` (??)
- `shared/schemas/agents.py` (??)

---

## Mise à jour automatique - 2026-06-16 10:45:10
...
| drive_api        | 3531  | 435  |  88% |
| items_api        | 2180  | 133  |  94% |
| missions_api     | 2231  | 281  |  87% |
| monitoring_mcp   | 1359  | 187  |  86% |
| platform-engineering | 2308  | 1550 |  33% |
| prompts_api      | 1353  | 250  |  82% |
| scratch          | N/A   | N/A  | N/A  |
| scripts          | N/A   | N/A  | N/A  |
| shared           | 3006  | 263  |  91% |
| tests            | 578   | 36   |  94% |
| users_api        | 2036  | 342  |  83% |
...
- `shared/HASH` (M)
- `shared/VERSION` (M)
- `shared/exception_handler.py` (M)
- `shared/fastapi_utils.py` (M)
- `shared/observability.py` (M)
- `shared/pyproject.toml` (M)
- `users_api/FILE_HASHES` (M)
- `users_api/HASH` (M)
...
- `all_logs.json` (??)
- `recent_logs.json` (??)
- `scripts/check_silent_exceptions.py` (??)
- `traceback.txt` (??)
...
| agent_hr_api     | 1564  | 102  |  93% |
| agent_missions_api | 1927  | 90   |  95% |
| agent_ops_api    | 1682  | 279  |  83% |
| agent_router_api | 3588  | 516  |  86% |
| analytics_mcp    | 1007  | 205  |  80% |
| competencies_api | 5727  | 901  |  84% |
| cv_api           | 10430 | 1540 |  85% |
| drive_api        | 3504  | 413  |  88% |
| items_api        | 2177  | 132  |  94% |
| missions_api     | 2231  | 281  |  87% |
| monitoring_mcp   | 1334  | 169  |  87% |
| platform-engineering | 2265  | 1529 |  32% |
| prompts_api      | 1350  | 252  |  81% |
| scratch          | N/A   | N/A  | N/A  |
| scripts          | 5607  | 5594 |   1% |
| shared           | 2937  | 301  |  90% |
...
- `agent_hr_api/metadata.py` (D)
- `agent_hr_api/spec.md` (M)
- `agent_missions_api/FILE_HASHES` (M)
- `agent_missions_api/HASH` (M)
- `agent_missions_api/VERSION` (M)
- `agent_missions_api/agent_missions_api.system_instruction.txt` (M)
- `agent_missions_api/metadata.py` (D)
- `agent_missions_api/tests/test_mcp.py` (M)
- `agent_ops_api/FILE_HASHES` (M)
- `agent_ops_api/HASH` (M)
- `agent_ops_api/VERSION` (M)
- `agent_ops_api/agent.py` (M)
...
- `competencies_api/src/competencies/analytics_queries.py` (M)
- `competencies_api/src/competencies/competencies_router.py` (M)
...
- `competencies_api/tests/test_assignments_functional.py` (M)
- `competencies_api/tests/test_competencies_crud.py` (M)
- `cv_api/FILE_HASHES` (M)
- `cv_api/HASH` (M)
- `cv_api/VERSION` (M)
- `cv_api/cv_api.generate_taxonomy_tree_map.txt` (M)
- `cv_api/eval/rag_quality_eval.py` (M)
- `cv_api/spec.md` (M)
- `cv_api/src/cvs/routers/_shared.py` (M)
...
- `cv_api/tests/test_taxonomy_pipeline_oidc.py` (M)
...
- `drive_api/src/routers/folders_router.py` (M)
- `drive_api/src/routers/ingestion_router.py` (M)
- `drive_api/src/routers/sync_router.py` (M)
- `drive_api/src/services/folder_service.py` (M)
- `drive_api/tests/test_folder_service.py` (M)
- `frontend/FILE_HASHES` (M)
- `frontend/HASH` (M)
- `frontend/VERSION` (M)
- `frontend/src/App.vue` (M)
...
- `platform-engineering/bundled_prompts/cv_api/cv_api.generate_taxonomy_tree.txt` (D)
...
- `platform-engineering/bundled_prompts/missions_api/requirements.txt` (D)
- `platform-engineering/bundled_prompts/prompts_api/prompts_api.error_correction.txt` (M)
- `platform-engineering/bundled_prompts/prompts_api/requirements.txt` (D)
- `platform-engineering/envs/dev.yaml` (M)
- `platform-engineering/envs/prd.yaml` (M)
- `platform-engineering/envs/uat.yaml` (M)
- `platform-engineering/manage_env.py` (M)
...
- `test_mod.py` (D)
- `test_overrides.py` (D)
- `test_pytest_sim.py` (D)
- `test_script.sh` (D)
- `todo.md` (M)
- `users_api/FILE_HASHES` (M)
- `users_api/HASH` (M)
- `users_api/VERSION` (M)
- `agent_hr_api/tests/test_metadata.py` (??)
- `agent_missions_api/tests/test_metadata.py` (??)
- `agent_ops_api/agent_ops_api.sre_triage.system_instruction.txt` (??)
- `agent_ops_api/sre_triage.py` (??)
- `agent_ops_api/tests/test_metadata.py` (??)
- `agent_ops_api/tests/test_sre_triage.py` (??)
- `agent_router_api/tests/test_agent.py` (??)
- `analytics_mcp/tools/sre_triage_tools.py` (??)
- `boussole-pro.csv` (??)
- `competencies_api/tests/test_ai_scoring.py` (??)
- `competencies_api/tests/test_analytics_queries.py` (??)
- `competencies_api/tests/test_deduplication_resolution.py` (??)
- `cv_api/tests/integration/test_taxonomy_pipeline_integration.py` (??)
- `cv_api/tests/test_admin_router.py` (??)
- `cv_api/tests/test_taxonomy_state_machine.py` (??)
- `db_migrations/changelogs/competencies/009-add-competency-to-acquire-flag.yaml` (??)
- `db_migrations/changelogs/competencies/010-fix-suggestions-created-at-nullable.yaml` (??)
- `docs/openapi/` (??)
- `frontend/src/views/HRSkillsToAcquire.vue` (??)
- `frontend/src/views/Warming.vue` (??)
- `frontend/src/views/__tests__/AdminReanalysis.stateMachine.spec.ts` (??)
- `grafana/dashboards/sre_data_quality.json` (??)
- `ml-cloud-platforms.csv` (??)
- `monitoring_mcp/tests/test_gcp_monitoring.py` (??)
- `monitoring_mcp/tools/gcp_monitoring_tools.py` (??)
- `platform-engineering/bundled_prompts/agent_ops_api/agent_ops_api.sre_triage.system_instruction.txt` (??)
- `platform-engineering/bundled_prompts/cv_api/cv_api.generate_taxonomy_tree_deduplicate.txt` (??)
- `platform-engineering/bundled_prompts/cv_api/cv_api.generate_taxonomy_tree_map.txt` (??)
- `platform-engineering/bundled_prompts/cv_api/cv_api.generate_taxonomy_tree_reduce.txt` (??)
- `platform-engineering/bundled_prompts/cv_api/cv_api.generate_taxonomy_tree_sweep.txt` (??)
- `platform-engineering/bundled_prompts/prompts_api/prompts_api.sre_triage.playbook.txt` (??)
- `platform-engineering/requirements.txt` (??)
- `platform-engineering/terraform/alert_policies_slo.tf` (??)
- `platform-engineering/terraform/alerting.tf` (??)
- `prompts_api/prompts_api.sre_triage.playbook.txt` (??)
- `scripts/demo_memories/` (??)
...
- `agent_commons/agent_commons/prompt_loader.py` (M)
- `agent_commons/tests/test_prompt_loader_cache.py` (M)
- `agent_hr_api/Dockerfile` (M)
- `agent_hr_api/FILE_HASHES` (M)
- `agent_hr_api/HASH` (M)
- `agent_hr_api/VERSION` (M)
...
- `agent_hr_api/requirements.txt` (M)
- `agent_hr_api/spec.md` (M)
- `agent_hr_api/tests/test_mcp.py` (M)
- `agent_hr_api/uv.lock` (M)
- `agent_missions_api/Dockerfile` (M)
- `agent_missions_api/FILE_HASHES` (M)
- `agent_missions_api/HASH` (M)
- `agent_missions_api/VERSION` (M)
- `agent_missions_api/hitl_router.py` (M)
- `agent_missions_api/mcp_client.py` (M)
- `agent_missions_api/pyproject.toml` (M)
- `agent_missions_api/requirements.txt` (M)
- `agent_missions_api/tests/test_agent_fallback.py` (M)
...
- `agent_ops_api/requirements.txt` (M)
- `agent_ops_api/spec.md` (M)
- `agent_ops_api/tests/test_mcp.py` (M)
- `agent_ops_api/uv.lock` (M)
- `agent_router_api/Dockerfile` (M)
- `agent_router_api/FILE_HASHES` (M)
- `agent_router_api/HASH` (M)
...
- `cv_api/tests/test_mock_gemini_config.py` (M)
- `cv_api/uv.lock` (M)
- `docker-compose.yml` (M)
- `drive_api/FILE_HASHES` (M)
- `drive_api/HASH` (M)
...
- `scripts/run_tests.sh` (M)
- `scripts/seed_data.py` (M)
- `tests/test_e2e_stateless.py` (M)
- `users_api/FILE_HASHES` (M)
- `users_api/HASH` (M)
- `users_api/VERSION` (M)
- `users_api/pyproject.toml` (M)
- `users_api/uv.lock` (M)
- `cv_api/gemini_mock_patch.py` (??)
- `docker-compose.perf-override.yml` (??)
- `items_logs.json` (??)
- `locust/data/competencies_seed.sql` (??)
- `locust/data/cv_seed.sql` (??)
- `locust/data/drive_seed.sql` (??)
- `locust/data/items_seed.sql` (??)
- `locust/data/prompts_seed.sql` (??)
- `locust/data/users_seed.sql` (??)
- `missions_logs.json` (??)
- `test_logs.json` (??)
- `tests/integration/` (??)
...
| agent_ops_api    | 1349  | 188  |  86% |
| agent_router_api | 3275  | 566  |  83% |
| analytics_mcp    | 933   | 141  |  85% |
| competencies_api | 4973  | 983  |  80% |
| cv_api           | 9501  | 1559 |  84% |
| drive_api        | 3496  | 426  |  88% |
| items_api        | 2177  | 132  |  94% |
| missions_api     | 2169  | 228  |  89% |
| monitoring_mcp   | 1162  | 128  |  89% |
| platform-engineering | 1497  | 1212 |  19% |
| prompts_api      | 1350  | 252  |  81% |
| shared           | 2928  | 298  |  90% |
| tests            | 456   | 38   |  92% |
| users_api        | 2013  | 342  |  83% |

### Modifications depuis le dernier push

#### Commits non pushés
- Fix PEP8 and test regressions

#### Fichiers (non commités)
- `agents/workflows/analyse-code-api.md` (M)
- `.agents/workflows/analyse-performance.md` (M)
- `.agents/workflows/analyse-ui-ux.md` (M)
- `agent_commons/agent_commons/circuit_breaker.py` (M)
- `agent_commons/agent_commons/mcp_client.py` (M)
- `agent_commons/agent_commons/prompt_loader.py` (M)
- `agent_commons/tests/test_mcp_client_propagation.py` (M)
- `agent_hr_api/FILE_HASHES` (M)
- `agent_hr_api/HASH` (M)
- `agent_hr_api/VERSION` (M)
- `agent_hr_api/agent.py` (M)
...
- `agent_missions_api/requirements.txt` (M)
- `agent_missions_api/session.py` (M)
- `agent_missions_api/session_router.py` (M)
- `agent_missions_api/tests/test_hitl_endpoints.py` (M)
- `agent_missions_api/tests/test_jwt_propagation.py` (M)
- `agent_missions_api/tests/test_maybe_trigger_hitl.py` (M)
- `agent_missions_api/uv.lock` (M)
- `agent_ops_api/FILE_HASHES` (M)
- `agent_ops_api/HASH` (M)
- `agent_ops_api/VERSION` (M)
...
- `agent_router_api/main.py` (M)
- `agent_router_api/mcp_client.py` (M)
- `agent_router_api/prompt_loader.py` (M)
- `agent_router_api/pyproject.toml` (M)
- `agent_router_api/requirements.txt` (M)
- `agent_router_api/router.py` (M)
- `agent_router_api/semantic_cache.py` (M)
...
- `agent_router_api/tests/test_mcp.py` (M)
- `agent_router_api/tests/test_sessions.py` (M)
- `agent_router_api/tests/test_workflow_agent.py` (M)
- `agent_router_api/tests/test_workflow_agent_perf.py` (M)
- `agent_router_api/tools_registry.py` (M)
- `agent_router_api/uv.lock` (M)
- `agent_router_api/workflow_agent.py` (M)
- `analytics_mcp/FILE_HASHES` (M)
- `analytics_mcp/HASH` (M)
- `analytics_mcp/VERSION` (M)
...
- `analytics_mcp/mcp_app.py` (M)
- `analytics_mcp/mcp_server.py` (M)
- `analytics_mcp/tests/test_mcp_server_extra.py` (M)
- `competencies_api/FILE_HASHES` (M)
- `competencies_api/HASH` (M)
- `competencies_api/VERSION` (M)
- `competencies_api/conftest.py` (M)
...
- `competencies_api/mcp_server.py` (M)
- `competencies_api/requirements.txt` (M)
- `competencies_api/scripts/cleanup_corrupted_competencies.py` (M)
- `competencies_api/scripts/cleanup_corrupted_competencies_api.py` (M)
- `competencies_api/scripts/list_all.py` (M)
- `competencies_api/src/competencies/ai_scoring.py` (M)
- `competencies_api/src/competencies/assignments_router.py` (M)
...
- `competencies_api/src/competencies/scoring_utils.py` (M)
- `competencies_api/src/competencies/tree_router.py` (M)
- `competencies_api/tests/test_scheduler_control.py` (M)
- `competencies_api/tools/batch_tools.py` (M)
- `competencies_api/tools/evaluation_tools.py` (M)
- `competencies_api/tools/tree_tools.py` (M)
...
- `cv_api/src/services/taxonomy_service.py` (M)
- `cv_api/tests/test_data_quality_publisher.py` (M)
- `cv_api/tools/profile_tools.py` (M)
- `db_migrations/FILE_HASHES` (M)
- `db_migrations/HASH` (M)
- `db_migrations/VERSION` (M)
- `docker-compose.yml` (M)
...
- `frontend/src/components/DriveErrorsPanel.vue` (M)
...
- `frontend/src/components/agent/CloudRunLogsViewer.vue` (M)
- `frontend/src/components/agent/ConsultantAvailabilityCard.vue` (M)
- `frontend/src/components/agent/ConsultantCard.vue` (M)
- `frontend/src/components/agent/HitlApproval.vue` (M)
- `frontend/src/components/agent/ItemCard.vue` (M)
- `frontend/src/components/agent/MissionCard.vue` (M)
- `frontend/src/components/agent/SessionPanel.vue` (M)
- `frontend/src/components/agent/SystemHealthCard.vue` (M)
- `frontend/src/components/agent/ToolExecutionList.vue` (M)
- `frontend/src/components/ui/BaseButton.vue` (M)
- `frontend/src/style.css` (M)
...
- `frontend/src/views/Specs.vue` (M)
- `frontend/src/views/UserDetail.vue` (M)
- `frontend/src/views/__tests__/MissionsList.spec.ts` (M)
- `frontend/vitest.log` (M)
- `items_api/FILE_HASHES` (M)
- `items_api/HASH` (M)
- `items_api/VERSION` (M)
...
- `items_api/tools/categories.py` (M)
- `items_api/tools/items.py` (M)
- `locust/data/seeded_ids.json` (M)
- `locust/locustfile.py` (M)
- `missions_api/FILE_HASHES` (M)
- `missions_api/HASH` (M)
...
- `missions_api/spec.md` (M)
- `missions_api/src/gemini_retry.py` (M)
- `missions_api/src/missions/analysis_service.py` (M)
- `missions_api/src/missions/document_extractor.py` (M)
- `missions_api/src/missions/helpers.py` (M)
- `mock_gemini/main.py` (M)
- `monitoring_mcp/FILE_HASHES` (M)
- `monitoring_mcp/HASH` (M)
- `monitoring_mcp/VERSION` (M)
- `monitoring_mcp/conftest.py` (M)
- `monitoring_mcp/mcp_app.py` (M)
- `monitoring_mcp/tests/test_data_tools.py` (M)
- `monitoring_mcp/tests/test_logs_tools.py` (M)
- `monitoring_mcp/tests/test_mcp_app.py` (M)
- `monitoring_mcp/tests/test_mcp_server.py` (M)
- `monitoring_mcp/tests/test_pipeline_tools.py` (M)
- `monitoring_mcp/tools/data_tools.py` (M)
- `monitoring_mcp/tools/infra_tools.py` (M)
...
- `prompts_api/mcp_server.py` (M)
- `prompts_api/spec.md` (M)
- `prompts_api/src/gemini_retry.py` (M)
- `prompts_api/src/prompts/analyzer.py` (M)
...
- `shared/database.py` (M)
- `shared/pyproject.toml` (M)
- `shared/schemas/auth.py` (M)
- `shared/schemas/pagination.py` (M)
- `shared/tests/test_edge_cases.py` (M)
...
- `agent_commons/tests/test_circuit_breaker_redis.py` (??)
- `agent_commons/tests/test_mcp_pre_generation_guardrail.py` (??)
- `agent_commons/tests/test_prompt_loader_cache.py` (??)
- `agent_router_api/tests/test_a2a_parallel.py` (??)
- `agent_router_api/tests/test_state_graph_agent.py` (??)
- `competencies_api/tests/test_assignments_functional.py` (??)
- `competencies_api/tests/test_evaluations_functional.py` (??)
- `frontend/src/composables/` (??)
- `prompts_api/tests/test_functional_coverage.py` (??)
- `scripts/audit/` (??)
- `scripts/audit_templates.py` (??)
- `shared/testing/` (??)
- `shared/tests/test_prompt_evaluation.py` (??)
- `tests/test_e2e_stateless.py` (??)
