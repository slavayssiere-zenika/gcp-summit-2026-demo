...
## MCP tools exposés
- `check_all_components_health`, `check_component_health`, `execute_read_only_query`, `get_ingestion_pipeline_status`, `get_redis_invalidation_state`, `get_service_logs`, `inspect_pubsub_dlq`, `list_alert_policies`, `list_alerts`, `list_gcp_services`, `list_timeseries`, `search_cloud_logs_by_trace`
