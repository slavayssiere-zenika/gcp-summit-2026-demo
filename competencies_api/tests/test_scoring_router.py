...
from src.competencies.scoring_router import verify_jwt_or_oidc
...
def override_verify_jwt_or_oidc():
    return {"sub": "scheduler", "role": "admin"}


app.dependency_overrides[verify_jwt] = override_verify_jwt
app.dependency_overrides[verify_jwt_or_oidc] = override_verify_jwt_or_oidc
