"""
Tests de non-régression : propagation du JWT sub comme user_id dans agent_ops_api.
...
def test_query_different_users_different_user_ids(client):
    ...
    async def capture(query, session_id, user_id="user_1", **kwargs):
        ...
        return {"response": "OK", "steps": [], "thoughts": "", "usage": {}, "source": "ops_agent"}
...
def test_history_uses_jwt_sub_as_user_id(client):
    ...
    with patch("history_routes.get_session_service", return_value=mock_svc):
