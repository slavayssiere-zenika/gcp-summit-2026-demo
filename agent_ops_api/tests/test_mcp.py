...
from mcp_client import (
    ...
    get_competencies_mcp, get_cv_mcp, get_items_mcp, get_users_mcp
)
...
async def test_mcp_sse_client_list_tools(mocker):
    _mock_sse = mocker.patch("mcp.client.sse.sse_client", new_callable=AsyncMock)  # noqa: F841
