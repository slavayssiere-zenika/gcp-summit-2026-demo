...
# NOTE: Le backend service externe (agent_ops_backend) a été supprimé.
# Les sous-agents sont uniquement accessibles via le LB interne (agent_ops_internal_backend).
